...
async function main() {
        ...
        try {
            ...
            if (!mapping) {
                ...
                try {
                    ...
                    console.log(`✓ Deleted from family calendar: ${uid.substring(0, 40)}...`);
                    successCount++;
                } catch (e) {
                    // Try other calendars if family didn't work
                    console.log(`⚠ Could not find event ${uid.substring(0, 40)}... might already be deleted`);
                    failCount++;
                }
            } else {
                ...
                console.log(`✓ Deleted: ${uid.substring(0, 30)}... -> ${mapping.googleEventId.substring(0, 30)}...`);
                successCount++;
            }
            ...
            console.error(`✗ Failed to delete ${uid.substring(0, 30)}...: ${error.message}`);
            failCount++;
        }
    }
    ...
    console.log('  1. Wait 1-2 minutes for sync');
