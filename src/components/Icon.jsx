...
const Icon = ({ name, size = 16, className = '', ...props }) => {
  ...
  const icons = {
    car: (
      <svg {...iconProps}>
        <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H9.6c-.7 0-1.3.3-1.8.7C7 8.6 5.7 10 5.7 10s-2.7.6-3.2 1.1C1.7 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2" />
    ...
    backpack: (
      <svg {...iconProps}>
        <path d="M5 18v-6a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2Z" />
